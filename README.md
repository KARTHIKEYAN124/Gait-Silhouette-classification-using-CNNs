...
The analysis is used to detect the walking patterns of the humans by using the Gait sillhoutte technique using CNN, MobileNetV2 and EfficientNetB0.
...
The program can be run on kaggle by downloading the Gait Silhouette classification using CNNs.inpyb file and importing it on Kaggle. 
Select GPU for faster processing of the code. 
